...
* **计算机视觉 (Computer Vision)**：聚焦细粒度图像分析、医学图像分析、小样本图像分类。
* **小样本学习 (Few-shot Learning)**：小样本细粒度图像分类 (Few-shot Fine-grained Image Classification)、小样本医学图像分割 (Few-shot Medical Image Segmentation)、3D 小样本图像分类 (3D Few-Shot Image Classification)。
* **深度学习 (Deep Learning)**
...
* **2026.06:** 🍽️🍽️ 23级毕业生谢师宴——祝23级三位毕业生前程似锦！轻舟已过万重山~
  <div align="center">
    <img src="/images/23_x.jpg" alt="23级谢师宴" width="600">
  </div>
...
* **2025.12:** 👏👏 恭喜课题组**贾朋昊**同学获得2025年国家奖学金！
  <div align="center">
    <img src="/images/jph_gj.jpg" alt="国家奖学金" width="400">
  </div>


* **2025.12:** 👏👏 恭喜课题组**阳玲**同学获得“华为杯”第二十二届中国研究生数学建模竞赛三等奖！
  <div align="center">
...
* **2025.04:** 🎉🎉 恭喜团队研究生**贾朋昊**一篇论文被Signal Processing (SCI,中科院二区, CCF-C)录用！

* **2025.03:** 🎉🎉 恭喜团队研究生**贾朋昊**一篇论文被Pattern Recognition Letters (SCI,中科院三区, CCF-C)录用！
...
* **2024.06:** 🎉🎉 祝贺 **朱东华**、**李小菲**、**韩岩奇** 同学成功获得硕士学位，硕士顺利毕业！ ✌️✌️
  <div align="center">
    <img src="/images/21.jpeg" alt="朱东华李小菲韩岩奇" width="600">
    <p><small><em>朱东华、李小菲、韩岩奇 · 硕士毕业合影</em></small></p>
  </div>

* **2023.12:** 🍽️🍽️ 23级新生入学宴——欢迎2023级硕士研究生贾朋昊、周琳杰、高雄加入团队 ✌️✌️
  <div align="center">
...
* **2023.06:** 🎉🎉 祝贺 **吕艳娜**、**张耀洪** 同学成功获得硕士学位，硕士顺利毕业！
  <div align="center">
    <img src="/images/20.jpeg" alt="吕艳娜张耀洪" width="600">
    <p><small><em>吕艳娜、张耀洪 · 硕士毕业合影</em></small></p>
  </div>
...
* 文浪,苟光磊,白瑞峰,等.双分支注意和特征交互的小样本细粒度学习[J].（CCF推荐中文核心期刊）
* 缪宛谕,苟光磊,钟声,等.多级决策优化关系网络的小样本学习方法[J].（CCF推荐中文核心期刊）
* 文浪,苟光磊,白瑞峰,等.基于邻域融合和特征增强的小样本细粒度图像分类[J].（CCF推荐中文核心期刊）
* 白瑞峰,苟光磊,文浪,等.基于粒球原型网络的小样本图像分类方法[J].（CCF推荐中文核心期刊）
* 李小菲,苟光磊,韩岩奇,等.多尺度知识引导局部增强的小样本细粒度图像分类方法[J].（CCF推荐中文核心期刊）
* 苟光磊,朱东华,李小菲,等.深度掩膜布朗距离协方差小样本分类方法[J].（CCF推荐中文核心期刊）
* 韩岩奇,苟光磊,李小菲,等.融合多粒度注意力特征的小样本分类模型[J].（CCF推荐中文核心期刊）
* 吕艳娜,苟光磊,张里博,等.深度置信网络的代价敏感多粒度三支决策模型研究[J].（CCF推荐中文核心期刊）
* 张耀洪,苟光磊,吕艳娜,等.一种基于序贯三支决策的图像识别方法[J].（CCF推荐中文核心期刊）
* 苟光磊,刘文星.深度融合多尺度结构信息的图像超分辨率算法[J].（CCF推荐中文核心期刊）
* 苟光磊,朱东旭,杨雨.基于卷积特征聚合的细粒度图像检索方法[J].（CCF推荐中文核心期刊）
* 苟光磊,杨雨,朱东旭.面向细粒度图像的数据关联代理损失[J].（CCF推荐中文核心期刊）
...
<table style="width:100%; border-collapse: collapse; text-align: center;">
  <thead>
    <tr style="background-color: #f2f2f2;">
      <th style="padding: 10px; border-bottom: 2px solid #ddd;">入校</th>
      <th style="padding: 10px; border-bottom: 2px solid #ddd;">姓名</th>
      <th style="padding: 10px; border-bottom: 2px solid #ddd;">毕业</th>
      <th style="padding: 10px; border-bottom: 2px solid #ddd;">毕业去向</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2024</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">贵州某公司</td>
    </tr>
    <tr>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2022</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">文浪</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2025</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">重庆某高校教师</td>
    </tr>
    <tr>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2022</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">章韬</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2025</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">重庆某高校教师</td>
    </tr>
    <tr>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2022</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">白瑞峰</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2025</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">重庆某高校教师</td>
    </tr>
    <tr>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2022</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">缪宛谕</td>
      <td style="padding: 10px; border-bottom: 1px solid #eee;">2025</td>
...
<p align="center">
  <font size="2">欢迎学术交流与合作。如有意向加入课题组，请通过邮件 ggl@cqut.edu.cn 联系我。</font>
</p>
